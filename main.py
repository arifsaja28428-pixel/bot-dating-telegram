...
# ==================== PENGATURAN BOT ====================
# TEMPELKAN TOKEN BARU DARI BOTFATHER DI BAWAH INI
TOKEN = "8872474814:AAEC307bTcTohYBf44YindhbNOhRVFc9T3k"

# Ganti dengan ID Telegram kamu (angka)
ADMIN_ID = 8670588012

# Batas pencarian harian gratis
MAX_DAILY_SEARCH = 100

ADMIN_USERNAME = "@anondating_id_bot"
PAYMENT_DETAILS = (
    "💳 **PILIHAN PEMBAYARAN VIP (1 BULAN)**\n\n"
    "• **DANA :** `085703333939` (a.n. Nama Kamu)\n"
...
def main():
    ...
    print("🤖 Bot Dating Anonim Berhasil Dijalankan di PythonAnywhere!")
    app.run_polling()
