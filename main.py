...
# ==================== PENGATURAN BOT ====================
TOKEN = "8872474814:AAGA9KxtZ395uVFTRYWgs9MSHB9pQ3fGScE"  # Masukkan Token dari @BotFather
ADMIN_ID = 8670588012  # Ganti dengan ID Angka Telegram kamu dari @userinfobot
MAX_DAILY_SEARCH = 100  # Batas pencarian gratis per hari

ADMIN_USERNAME = "@brobro2612"  # Username Telegram kamu
PAYMENT_DETAILS = (
